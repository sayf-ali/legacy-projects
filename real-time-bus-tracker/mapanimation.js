  ...
  var map = new mapboxgl.Map({
      ...
      pitch: 50, //Added for map tilt
      bearing: -20, //Added for map angle
      zoom: 13.25,      
  });
...
//Start Hover Over Marker Popup Code
...
//End Hover Over Marker Popup Code
...
// Create a popup, but does not add it to the map yet
...
// Move bus marker along bus stops
let counter = 0;
function move(){
  setTimeout(()=>{
